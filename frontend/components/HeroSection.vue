<template>
    <section class="relative bg-[#f3f7f4] h-auto lg:mt-28 lg:pb-20 overflow-hidden">
        <nuxt-img provider="static" src="/images/gradient-radial4.png"
            class="absolute -left-40 lg:-left-96 lg:-top-24 w-[400px] h-[400px] lg:w-[900px] lg:h-[900px]"
            alt="gradient4" />
            ...
            <div class="flex flex-col lg:flex-wrap lg:h-[600px]">
                ...
                <div class="relative lg:static z-20 h-[500px] lg:h-full max-w-full mt-24 flex justify-center items-center">
                    <div
                        ...
                        <nuxt-img provider="static" class="object-cover" src="/images/desktop-meetdemocracy.png"
                            alt="desktop-image" />
                    </div>
                    <div
                        ...
                        <nuxt-img provider="static" class="object-cover" src="/images/laptop-meetdemocracy.png"
                            alt="laptop-image" />
                    </div>
                    <div
                        ...
                        <nuxt-img provider="static" class="object-cover" src="/images/tablette-meetdemocracy.png"
                            alt="tablette-image" />
                    </div>
                    <div
                        ...
                        <nuxt-img provider="static" class="object-cover" src="/images/phone-meetdemocracy.png"
